...
var useAICheatingDetection = (onViolation) => {
  const [isModelLoaded, setIsModelLoaded] = (0, import_react.useState)(false);
  ...
  const faceDetectorRef = (0, import_react.useRef)(null);
  const objectDetectorRef = (0, import_react.useRef)(null);
  const videoRef = (0, import_react.useRef)(null);
  const detectionIntervalRef = (0, import_react.useRef)(null);
  const noFaceTimerRef = (0, import_react.useRef)(null);
  const noFaceDurationRef = (0, import_react.useRef)(0);
  const lastViolationTimeRef = (0, import_react.useRef)({});
  const lastFrameTimeRef = (0, import_react.useRef)(0);
  const detectionActiveRef = (0, import_react.useRef)(false);
  const multipleFaceStreakRef = (0, import_react.useRef)(0);
  const phoneDetectionStreakRef = (0, import_react.useRef)(0);
  const objectDetectionStreakRef = (0, import_react.useRef)(0);
  ...
  const getFaceBox = (0, import_react.useCallback)((detection) => {
  ...
  const getDistinctFaceDetections = (0, import_react.useCallback)((detections, videoElement) => {
  ...
  const detectMultipleFaces = (0, import_react.useCallback)((distinctFaces) => {
  ...
  const detectNoFace = (0, import_react.useCallback)((distinctFaces) => {
    const faceCount = distinctFaces.length;
    if (faceCount === 0) {
  ...
  const detectPhone = (0, import_react.useCallback)((objectDetections) => {
  ...
  const detectSuspiciousObject = (0, import_react.useCallback)((objectDetections) => {
    if (!objectDetections || !objectDetections.detections) return null;
  ...
  const detectLookingDown = (0, import_react.useCallback)((distinctFaces) => {
  ...
  const runDetection = (0, import_react.useCallback)(async () => {
  ...
  const startDetection = (0, import_react.useCallback)(async (videoElement) => {
  ...
  const stopDetection = (0, import_react.useCallback)(() => {
  ...
  const testViolation = (0, import_react.useCallback)((type = "multiple_faces") => {
